...
require (
	github.com/confidential-containers/cloud-api-adaptor v0.0.1-alpha
...
require (
	...
	github.com/IBM/vpc-go-sdk v0.32.0 // indirect
...
replace github.com/confidential-containers/cloud-api-adaptor => ../
